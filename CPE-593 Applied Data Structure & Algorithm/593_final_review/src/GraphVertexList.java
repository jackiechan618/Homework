...
//		}
	...
	public static void main(String[] args){
		GraphVertexList g1 = new GraphVertexList(6);
		g1.add(1, 2, 1.0);		
		g1.add(1, 4, 2.0);
		g1.add(2, 4, 1.0);
		g1.add(2, 3, 2.0);
		...
		GraphVertexList g2 = new GraphVertexList(6);
		g2.add(1, 2, 2.5);		
		g2.add(1, 4, 1.2);
		g2.add(2, 4, 0.6);
		g2.add(2, 3, 2.5);
		...
		GraphVertexList g3 = new GraphVertexList(5);
		g3.add(1, 2, 2.5);		
		g3.add(1, 4, 1.2);
		g3.add(1, 5, 2.0);
		g3.add(2, 4, 0.6);
...
//		System.out.println(g.isConnect());
		...
		System.out.println("Bellman_Ford_Path: smallest cost is " + g1.Bellman_Ford_Path());
		System.out.println("Floyd_Warshall_Path: smallest cost is " + g1.Floyd_Warshall_Path());
	}
}
