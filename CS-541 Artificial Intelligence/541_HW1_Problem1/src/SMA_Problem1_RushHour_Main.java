...
/*********************************************************************************************************
 * Code for Problem1 (Rush Hour), HW1 using SMA* algorithm
 * Auther:  Feng Chen
 * CWID:    10400586
 ...
 * 
 * Each tuples in input should be separated by space, for example: 
 * 		(1). Easy 1 
 * 			start status:  IHC3 CVA3 BHB4 CVC5 CVE5
 * 			target status: IHC5 CVD3 BHB2 CVA5 CVE5
 * 		(2). Easy 5
 * 			start status:  IHC4 CVA4 BVA6 CVD4 CHE5
 * 			target status: IHC5 CVA4 BVD6 CVD4 CHE2
 * 
 **********************************************************************************************************/
