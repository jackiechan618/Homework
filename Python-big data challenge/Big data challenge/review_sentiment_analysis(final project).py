...
def single_review_sentiment_score(seg_sent):
    ...
    for word in seg_sent:  
        ...
        # formating the sentiment sorce and sendingsentiment score of the whole sentence to the review_sentiment_score
...
def review_sentiment_analysis(review):  
    ...
    # change the letter into lowercase and delete symbols including "\t" and "\r" 
...
filelist=['negative.txt','positive.txt','mostdict.txt', 'verydict.txt', 'moredict.txt','ishdict.txt','insufficientdict.txt','inversedict.txt']

# opening and reading from the files
...
#           (a) input one comment on the screen to get the sentiment analysis
#           (b) input "exit" to exit
#
##########################################################################################################    

print "Sentiment analysis"
print "Please input you recommend(input \"exit\" to exit):"
inputsent = sys.stdin.readline()
review = inputsent[0:len(inputsent)-1]

while review != 'exit':     
    # sentiment analysis and output the result    
    print_string="the recommend is: " + review_sentiment_analysis(review) + '\n'
    print print_string
    print "Sentiment analysis"
    print "Please input you recommend(input \"exit\" to exit):"
    inputsent = sys.stdin.readline()
